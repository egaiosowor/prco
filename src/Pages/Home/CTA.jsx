        ...
        <section className='lg:flex' >
            ...
            <div className='py-12 px-10 lg:px-16 lg:py-20 space-y-10 basis-1/2 text-white bg-[#0A3833]' >
                    <div className='space-y-2' >
                        ...
                        <p className='max-w-[45ch]' >Excavating purpose is among the rewarding journeys companies can take. PRCO helps organizations embrace purpose to achieve higher returns, employee engagement, and customer satisfaction.</p>
                    </div>
                    <div>
